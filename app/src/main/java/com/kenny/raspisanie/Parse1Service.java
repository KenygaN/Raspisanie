...
public class Parse1Service extends Service {
    ...
    class Task extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            nr.log("http://bgaek.by/rasp/stats.php?brand="+brand+"&model="+model+"&version="+version+"&otdel=byx");
            load("http://bgaek.by/rasp/stats.php?brand="+brand+"&model="+model+"&version="+version+"&otdel=byx");
            doc_title = load("http://bgaek.by/category/%D1%80%D0%B0%D1%81%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D0%B5/buh-otdel/");
            ...
            if (doc_title != null) {
                ...
                if (date3 != nr.date(getApplicationContext(), 3)) {
                    //111111111
                    doc = load(url1);
